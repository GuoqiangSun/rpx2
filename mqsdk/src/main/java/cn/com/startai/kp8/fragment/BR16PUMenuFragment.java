 ...
 * interface.
 */
public class BR16PUMenuFragment extends Fragment {

    public  static final String FW_ID = "BR16PU21";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_br16pu_menu, null, false);
        bindView();
        return rootView;
    }
...
//        animationFadeIn.setStartOffset(100);
    ...
    public void sendCommond(String hexCommond){
        StartAI.getInstance().getBaseBusiManager().passthrough(((BR16PUMasterActivity)getActivity()).getDevice().getId(), hexCommond, ((BaseActivity)getActivity()).onCallListener);
    }
    public  void  switchBtnStatus(Map<Integer,Integer> commondMap){
        ...
        for (Map.Entry<Integer, Integer> en : commondMap.entrySet()) {
            ...
            if(en.getKey() == R.id.btn_on_off) {
                if (1 == en.getValue()) {
                    ...
                    btn_on_off.setBackgroundResource(R.mipmap.brand_puma); // 白色
                    ...
                    btn_on_off.setBackgroundResource(R.mipmap.brand_puma_gray); //灰色
            ...
            if(en.getKey() == R.id.btn_z6) {
                if (1 == en.getValue()) {
                    ...
                    panel_tv_z6.setText(R.string.menu_pch_lgt_on);
                    ...
                    panel_tv_z6.setText(R.string.menu_pch_lgt_off);
                    panel_tv_z6.setTextColor(color_gray);
                    boolBtn_z6 = 0;
                }
            }
            if(en.getKey() == R.id.btn_z7) {
                if (1 == en.getValue()) {
                    ...
                    panel_tv_z7.setText(R.string.menu_awn_lgt_on);
                    ...
                    panel_tv_z7.setText(R.string.menu_awn_lgt_off);
                    panel_tv_z7.setTextColor(color_gray);
                    boolBtn_z7 = 0;
                }
            }
            if(en.getKey() == R.id.btn_z8) {
                if (1 == en.getValue()) {
                    ...
                    panel_tv_z8.setText(R.string.menu_wifi_on);
                    ...
                    panel_tv_z8.setText(R.string.menu_wifi_off);
                    panel_tv_z8.setTextColor(color_gray);
                    boolBtn_z8 = 0;
                }
            }
            if(en.getKey() == R.id.btn_z4) {
                if (1 == en.getValue()) {
                    ...
                    panel_tv_z4.setText(R.string.menu_zone2_on);
                    ...
                    panel_tv_z4.setText(R.string.menu_zone2_off);
                    panel_tv_z4.setTextColor(color_gray);
                    boolBtn_z4 = 0;
                }
            }
            if(en.getKey() == R.id.btn_z5) {
                if (1 == en.getValue()) {
                    ...
                    panel_tv_z5.setText(R.string.menu_zone3_on);
                    ...
                    panel_tv_z5.setText(R.string.menu_zone3_off);
                    panel_tv_z5.setTextColor(color_gray);
                    boolBtn_z5 = 0;
                }
            }
            ...
            if(en.getKey() == R.id.btn_m4) {
                if (-1 == en.getValue()) {
                    ...
                    panel_tv_m4.setText(R.string.menu_awning_off);
                    ...
                    panel_tv_m4.setText(R.string.menu_awning_on);
                    panel_tv_m4.setTextColor(color_gray);
                    boolBtn_m4 = 1;
                } else {
                        /*btn_z5.setBackgroundResource(R.mipmap.oem_acc1);
        ...
        if(powerChange) {
            disableButtons(boolBtn_on_off == 1? true:false);
            powerChange = false;
        }
        if(0 == boolBtn_on_off) {
