...
public class BR16WPMenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_br16wp_menu, null, false);
        bindView();
        return rootView;
    }
...
//        animationFadeIn.setStartOffset(100);
    ...
    public void sendCommond(String hexCommond){
        StartAI.getInstance().getBaseBusiManager().passthrough(((BR16WPMasterActivity)getActivity()).getDevice().getId(), hexCommond, ((BaseActivity)getActivity()).onCallListener);
    }
