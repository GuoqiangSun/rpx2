 ...
 * interface.
 */
public class Rp86MMenuFragment extends Fragment {

    public static final String FW_ID = "BR16RT21";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_rp86m_menu, null, false);
        bindView();
        destroy = false;
        return rootView;
    }
...
/*layoutParams = layout_logo.getLayoutParams();
    ...
    public void sendCommond(String hexCommond) {
        ...
        if (activity == null) {
            TAndL.L(" activity is null ");
            return;
        }

        String deviceID = ((Rp86MMasterActivity) activity).getDeviceID();

        String mac = ((Rp86MMasterActivity) activity).getDeviceMac();
        String ipByMac = NetworkManager.getInstance().getIpByMac(mac);
        boolean b = NetworkManager.getInstance().canLanControl(mac);

        Tlog.d(NetworkManager.TAG, "sendCommond() mac:" + mac + " ipByMac:" + ipByMac + " Lancontrol:" + b + hexCommond);

        if (ipByMac != null && (deviceID == null || b)) {
            byte[] bytes = HexUtil.hexStringToBytes(hexCommond);
            ResponseData mResponseData = new ResponseData(mac, bytes);
            mResponseData.obj = ipByMac;
            NetworkManager.getInstance().onOutputDataToServer(mResponseData);
            return;
        }

        if (deviceID != null) {

            StartAI.getInstance().getBaseBusiManager().passthrough(deviceID,
                    hexCommond,
                    ((BaseActivity) getActivity()).onCallListener);
        }
        ...
        for (Map.Entry<Integer, Integer> en : commondMap.entrySet()) {
            ...
            if (en.getKey() == R.id.btn_on_off) {
                if (1 == en.getValue()) {
                    ...
                    btn_on_off.setBackgroundResource(R.mipmap.rp8_layout_logo); // 白色
                    ...
                    btn_on_off.setBackgroundResource(R.mipmap.rp8_layout_logo_gray); //灰色
            ...
            if (en.getKey() == R.id.btn_z3) {
                if (1 == en.getValue()) {
                    ...
                    panel_tv_z3.setText(R.string.menu_lvr_lgt_on);
                    ...
                    panel_tv_z3.setText(R.string.menu_lvr_lgt_off);
                    panel_tv_z3.setTextColor(color_gray);
                    boolBtn_z3 = 0;
                }
            }
            ...
            if (en.getKey() == R.id.btn_z1) {
                if (1 == en.getValue()) {/*
                    ...
                    panel_tv_z1.setText(R.string.menu_pch_lgt_on);
                    ...
                    panel_tv_z1.setText(R.string.menu_pch_lgt_off);
                    panel_tv_z1.setTextColor(color_gray);
                    boolBtn_z1 = 0;
                }
            }
            if (en.getKey() == R.id.btn_z6) {
                if (1 == en.getValue()) {
                    ...
                    panel_tv_z6.setText(R.string.menu_zone2_on);
                    ...
                    panel_tv_z6.setText(R.string.menu_zone2_off);
                    panel_tv_z6.setTextColor(color_gray);
                    boolBtn_z6 = 0;
                }
            }
            if (en.getKey() == R.id.btn_z7) {
                if (1 == en.getValue()) {
                    ...
                    panel_tv_z7.setText(R.string.menu_zone3_on);
                    ...
                    panel_tv_z7.setText(R.string.menu_zone3_off);
                    panel_tv_z7.setTextColor(color_gray);
                    boolBtn_z7 = 0;
                }
            }
            if (en.getKey() == R.id.btn_z8) {
                if (1 == en.getValue()) {
                    ...
                    panel_tv_z8.setText(R.string.menu_z4_on);
                    ...
                    panel_tv_z8.setText(R.string.menu_z4_off);
                    panel_tv_z8.setTextColor(color_gray);
                    boolBtn_z8 = 0;
                }
            }
            if (en.getKey() == R.id.btn_z4) {
                if (1 == en.getValue()) {
                    ...
                    panel_tv_z4.setText(R.string.menu_awn_lgt_on);
                    ...
                    panel_tv_z4.setText(R.string.menu_awn_lgt_off);
                    panel_tv_z4.setTextColor(color_gray);
                    boolBtn_z4 = 0;
                }
            }
            if (en.getKey() == R.id.btn_z5) {
                if (1 == en.getValue()) {
                    ...
                    panel_tv_z5.setText(R.string.menu_zone1_on);
                    ...
                    panel_tv_z5.setText(R.string.menu_zone1_off);
                    panel_tv_z5.setTextColor(color_gray);
                    boolBtn_z5 = 0;
                }
            }
            if (en.getKey() == R.id.btn_m1) {
                if (-1 == en.getValue()) {
                    ...
                    panel_tv_m1.setText(R.string.menu_slide1_off);
                    ...
                    panel_tv_m1.setText(R.string.menu_slide1_on);
                    panel_tv_m1.setTextColor(color_gray);
                    boolBtn_m1 = 1;
                } else {
                        /*btn_z5.setBackgroundResource(R.mipmap.oem_acc1);
            ...
            if (en.getKey() == R.id.btn_m2) {
                if (-1 == en.getValue()) {
                    ...
                    panel_tv_m2.setText(R.string.menu_slide2_off);
                    ...
                    panel_tv_m2.setText(R.string.menu_slide2_on);
                    panel_tv_m2.setTextColor(color_gray);
                    boolBtn_m2 = 1;
                } else {
                        /*btn_z5.setBackgroundResource(R.mipmap.oem_acc1);
            ...
            if (en.getKey() == R.id.btn_m3) {
                if (-1 == en.getValue()) {
                    ...
                    panel_tv_m3.setText(R.string.menu_slide3_off);
                    ...
                    panel_tv_m3.setText(R.string.menu_slide3_on);
                    panel_tv_m3.setTextColor(color_gray);
                    boolBtn_m3 = 1;
                } else {
                        /*btn_z5.setBackgroundResource(R.mipmap.oem_acc1);
            ...
            if (en.getKey() == R.id.btn_m5) {
                if (-1 == en.getValue()) {
                    ...
                    panel_tv_m5.setText(R.string.menu_jack1_off);
                    ...
                    panel_tv_m5.setText(R.string.menu_jack1_on);
                    panel_tv_m5.setTextColor(color_gray);
                    boolBtn_m5 = 1;
                } else {
                        /*btn_z5.setBackgroundResource(R.mipmap.oem_acc1);
            ...
            if (en.getKey() == R.id.btn_m6) {
                if (-1 == en.getValue()) {
                    ...
                    panel_tv_m6.setText(R.string.menu_jack2_off);
                    ...
                    panel_tv_m6.setText(R.string.menu_jack2_on);
                    panel_tv_m6.setTextColor(color_gray);
                    boolBtn_m6 = 1;
                } else {
                        /*btn_z5.setBackgroundResource(R.mipmap.oem_acc1);
