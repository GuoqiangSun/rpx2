...
public class BR16IRMasterActivity extends BaseActivity {
    ...
    private BR16IRMenuFragment menuFragment;
    ...
    private void initView() {
        ...
        menuFragment = new BR16IRMenuFragment();
        ...
        mBluetoothService.notify(
                ...
                new BleCharacterCallback() {
                    ...
                    public void onSuccess(final BluetoothGattCharacteristic characteristic) {
                        ...
                        int auth = commondUtils.resolveAuth(BR16IRMasterActivity.this,characteristic.getValue());
                        if(-1 != auth){
    ...
    public void setViewPagerCurrentItem(int currentItem) {
        viewPager.setCurrentItem(currentItem, false); // BR16IRMenuFragment
    }
...
//            progressDialog.show();
        ...
        public void onConnectFail() {
            Toast.makeText(BR16IRMasterActivity.this, "ConnectFail", Toast.LENGTH_LONG).show();
        }
        ...
        public void onDisConnected2Reconnect(){
            bluetoothFragment.changeConnectState(false);
            Toast.makeText(BR16IRMasterActivity.this, "Reconnecting", Toast.LENGTH_LONG).show();
        }
        @Override
        public void onServicesDiscovered() {
            ...
            Toast.makeText(BR16IRMasterActivity.this, "ServicesDiscovered", Toast.LENGTH_LONG).show();
        }
    };
