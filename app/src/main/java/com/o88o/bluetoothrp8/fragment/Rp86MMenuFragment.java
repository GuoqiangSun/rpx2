...
public class Rp86MMenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.rp86m_fragment_menu, null, false);
        bindView();
        return rootView;
    }
...
//        animationFadeIn.setStartOffset(100);
    ...
    public void switchVersionRunnable(String version){
        ...
        if(FW_ID.equals(version) || null == version || version.isEmpty()){
            ...
            Toast.makeText(getActivity(),"请求主机"+hexCommond,Toast.LENGTH_LONG).show();
            return;
        }
