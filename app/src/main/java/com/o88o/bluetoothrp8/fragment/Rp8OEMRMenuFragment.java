 ...
 * interface.
 */
public class Rp8OEMRMenuFragment extends Fragment {

    public  static final String FW_ID = "BR08TR11";
    ...
    private LongClickButton btn_2,panel_btn_2;
    ...
    private Integer bollblink_live = 0;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.rp8oemr_fragment_menu, null, false);
        bindView();
        return rootView;
    }
    ...
    private void bindView(){
        ...
        btn_2 = (LongClickButton)rootView.findViewById(R.id.btn_2);
        ...
        panel_btn_2 = (LongClickButton)rootView.findViewById(R.id.panel_btn_2);
        ...
        // 长按 和 抬起
        btn_2.setLongClickUpListener(getLongClickUpDownListener());
        panel_btn_2.setLongClickUpListener(getLongClickUpDownListener());
...
//        animationFadeIn.setStartOffset(100);
    ...
    private LongClickButton.LongClickUpListener getLongClickUpDownListener() {
        return new LongClickButton.LongClickUpListener() {
            ...
            public void upAction() {
                if(null != mBluetoothService) {
                    ...
                    hexCommond.append(Rp8OEMRCommond.HEX_REQUEST_FUNC_CLOSE);
                    hexCommond.append(Rp8OEMRCommondUtils.crc8(hexCommond.toString()));
                    sendCommond(hexCommond.toString());//genCommond(R.id.btn_2)
                    /*btn_2.setBackgroundResource(R.mipmap.rp8r_btn_horn);
                    panel_btn_2.setBackgroundResource(R.mipmap.rp8r_panel_horn);*/
                }
            }
            ...
            public void downAction() {
                if(null != mBluetoothService) {
                    ...
                    hexCommond.append(Rp8OEMRCommond.HEX_COMMOND_TYPE_GET);
                    hexCommond.append(Rp8OEMRCommond.HEX_REQUEST_DEVICE8);
                    hexCommond.append(Rp8OEMRCommond.HEX_REQUEST_FUNC_OPEN_1);
                    hexCommond.append(Rp8OEMRCommondUtils.crc8(hexCommond.toString()));
                    sendCommond(hexCommond.toString());//genCommond(R.id.btn_2)
                    /*btn_2.setBackgroundResource(R.mipmap.rp8r_btn_horn_red);
                    panel_btn_2.setBackgroundResource(R.mipmap.rp8r_panel_horn_red);*/
                }
            }
            ...
            switch (en.getKey()) {
                ...
                case R.id.btn_2:
                    if (1 == en.getValue()) {
                        btn_2.setBackgroundResource(R.mipmap.rp8r_btn_horn_red);
                        panel_btn_2.setBackgroundResource(R.mipmap.rp8r_panel_horn_red);//
                        panel_tv_2.setText(R.string.menu_horn_on);
                        panel_tv_2.setTextColor(color_gray);
                        boolBtn_2 = 1;
                    } else {
                        btn_2.setBackgroundResource(R.mipmap.rp8r_btn_horn);
                        panel_btn_2.setBackgroundResource(R.mipmap.rp8r_panel_horn);//白色
                        panel_tv_2.setText(R.string.menu_horn_off);
                        panel_tv_2.setTextColor(color_gray);
                        boolBtn_2 = 0;
                    }
                    break;
    ...
    private void grayButtons(){
        ...
        btn_2.setBackgroundResource(R.mipmap.rp8r_btn_horn_gray);
        ...
        panel_btn_2.setBackgroundResource(R.mipmap.rp8r_panel_horn_gray);
