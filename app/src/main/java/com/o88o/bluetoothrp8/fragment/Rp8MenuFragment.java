...
import com.o88o.bluetoothrp8.util.Rp8Commond;
import com.o88o.bluetoothrp8.util.Rp8CommondUtils;
 ...
 * interface.
 */
public class Rp8MenuFragment extends Fragment {
    public  static final String FW_ID = "BR08RT11";
    ...
    private String[] rp = {"RP8","RP8-OEMR", "RP5"};
    private String[] brand = {"Customize", "GatorTail", "SmokerCraft", "Tracker", "Xpress", "other"};
    ...
    private ImageView panel_logo,layout_logo,layout_bt;
    private Button layout_wifi;
    ...
    private Rp8CommondUtils commondUtils = new Rp8CommondUtils();
    private FullScrreenDialog dialog;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.rp8_fragment_menu, null, false);
        bindView();
        return rootView;
    }
    ...
    public boolean initBluetoothService() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                //sendCommond(Rp8Commond.HEX_REQUEST_FIRST + Rp8CommondUtils.crc8(Rp8Commond.HEX_REQUEST_FIRST));
                sendCommond(Rp8Commond.HEX_REQUEST_VERSION + Rp8CommondUtils.crc8(Rp8Commond.HEX_REQUEST_VERSION));

            }
        }, 100);

        Toast.makeText(getActivity(), "send firt commend : "+Rp8Commond.HEX_REQUEST_VERSION + Rp8CommondUtils.crc8(Rp8Commond.HEX_REQUEST_VERSION), Toast.LENGTH_LONG).show();
        return true;
    }
    ...
    private void bindView(){
        ...
        //linearLayoutDown = (LinearLayout)rootView.findViewById(R.id.linearLayout_down);
        ...
        layout_wifi = (Button)rootView.findViewById(R.id.layout_wifi);
        ...
        animationFadeInVariable.setDuration(OPEN_BREATH_INTERVAL_TIME);
    ...
    private void switchBrand(int brandIndex){
        switch (brandIndex){
            case 0:
                btn_brand.setBackground(null);
                break;
            case 1:  // 1,2,3,4
                //{"Customize", "GatorTail", "SmokerCraft", "Tracker", "Xpress", "other"}
                btn_brand.setBackgroundResource(R.mipmap.brand_gatortail);
                break;
            case 2:  // 1,2,3,4
                //{"Customize", "GatorTail", "SmokerCraft", "Tracker", "Xpress", "other"}
                btn_brand.setBackgroundResource(R.mipmap.brand_smokercraft);
                break;
            case 3:  // 1,2,3,4
                //{"Customize", "GatorTail", "SmokerCraft", "Tracker", "Xpress", "other"}
                btn_brand.setBackgroundResource(R.mipmap.brand_tracker);
                break;
            case 4:  // 1,2,3,4
                //{"Customize", "GatorTail", "SmokerCraft", "Tracker", "Xpress", "other"}
                btn_brand.setBackgroundResource(R.mipmap.brand_xpress);
                break;
            case 5:
                btn_brand.setBackground(null);
                break;
    ...
    private void autoAdatper() {
        ...
        MetricsUtils.setTextSize((float) scaleRatio * MetricsUtils.sp2px(getContext(),28),
    ...
    public String genCommond(View view){
        ...
        hexCommond.append(Rp8Commond.HEX_COMMOND_START);
        hexCommond.append(Rp8Commond.HEX_COMMOND_DATA_LENGTH);
        hexCommond.append(Rp8Commond.HEX_COMMOND_TYPE_GET);
        // 只发键值，状态由继电器控制切换
        switch (view.getId()) {
            case R.id.panel_btn_1:
            case R.id.btn_1:
                hexCommond.append(Rp8Commond.HEX_REQUEST_DEVICE7);
                break;
            case R.id.panel_btn_2:
            case R.id.btn_2:
                hexCommond.append(Rp8Commond.HEX_REQUEST_DEVICE8);
                break;
            case R.id.panel_btn_b:
            case R.id.btn_b:
                hexCommond.append(Rp8Commond.HEX_REQUEST_DEVICE4);
                break;
            case R.id.panel_btn_s:
            case R.id.btn_s:
                hexCommond.append(Rp8Commond.HEX_REQUEST_DEVICE6);
                break;
            case R.id.panel_btn_m:
            case R.id.btn_m:
                hexCommond.append(Rp8Commond.HEX_REQUEST_DEVICE5);
                break;
            case R.id.btn_on_off:
            case R.id.panel_btn_power:
                hexCommond.append(Rp8Commond.HEX_REQUEST_DEVICE1);
                break;
            case R.id.panel_btn_3:
            case R.id.btn_3:
                hexCommond.append(Rp8Commond.HEX_REQUEST_DEVICE9);
                break;
            /*case R.id.panel_btn_nav:
                hexCommond.append(Rp8Commond.HEX_REQUEST_DEVICE2);
                break;
            case R.id.panel_btn_anchor:
                hexCommond.append(Rp8Commond.HEX_REQUEST_DEVICE3);
                break;*/
            case R.id.panel_btn_nav:
            case R.id.btn_nav:
                hexCommond.append(Rp8Commond.HEX_REQUEST_DEVICE10);
                break;
            default:
        }
        hexCommond.append(Rp8Commond.HEX_REQUEST_FUNC_DATA);
        hexCommond.append(Rp8CommondUtils.crc8(hexCommond.toString()));
    ...
    public  void  switchBtnStatus(Map<Integer,Integer> commondMap){
        ...
        for (Map.Entry<Integer, Integer> en : commondMap.entrySet()) {
            switch (en.getKey()) {
                ...
                case R.id.panel_btn_anchor:
                    if (1 == en.getValue()) {
                        //panel_btn_anchor.setBackgroundResource(R.mipmap.rp8_panel_btn_anchor_red);
                        boolPanel_anchor = 1;
                    } else {
                        //panel_btn_anchor.setBackgroundResource(R.mipmap.rp8_panel_btn_anchor);
                        boolPanel_anchor = 0;
                    }
                    break;
                case R.id.panel_btn_nav:
        ...
        //panel_logo.setBackgroundResource(R.mipmap.rp8_panel_logo);
        if(powerChange) {
    ...
    public void disableButtons(boolean isEnabled){
        ...
        //panel_btn_power.setEnabled(isEnabled);
    ...
    private void grayButtons(){
        ...
        btn_nav.setTextColor(color_gray);

        panel_btn_3.setTextColor(color_gray);
        ...
        panel_btn_nav.setTextColor(color_gray);
