 ...
 * interface.
 */
public class Rp8GTMenuFragment extends Fragment {
    public  static final String FW_ID = "BR08GT11";
    ...
    private ImageView panel_logo,layout_logo,layout_wifi,layout_bt;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.rp8gt_fragment_menu, null, false);
        bindView();
        return rootView;
    }
    ...
    public  void  switchBtnStatus(Map<Integer,Integer> commondMap){
        ...
        for (Map.Entry<Integer, Integer> en : commondMap.entrySet()) {
            switch (en.getKey()) {
                ...
                case R.id.btn_m:
                    if (1 == en.getValue()) {
                        btn_m.setBackgroundResource(R.mipmap.btn_light_red);
                        panel_btn_m.setBackgroundResource(R.mipmap.btn_light_red);
                        panel_tv_m.setText(R.string.menu_swamp_lgt_on);
                        panel_tv_m.setTextColor(color_gray);
                        boolBtn_m = 1;
                    } else {
                        btn_m.setBackgroundResource(R.mipmap.btn_light);
                        panel_btn_m.setBackgroundResource(R.mipmap.btn_light);
                        panel_tv_m.setText(R.string.menu_swamp_lgt_off);
                        panel_tv_m.setTextColor(color_gray);
                        boolBtn_m = 0;
                    }
                    break;
    ...
    private void grayButtons(){
        ...
        btn_m.setBackgroundResource(R.mipmap.btn_light_gray);
        ...
        panel_btn_m.setBackgroundResource(R.mipmap.btn_light_gray);
