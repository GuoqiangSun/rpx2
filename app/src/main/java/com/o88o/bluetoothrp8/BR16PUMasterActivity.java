        ...
        mBluetoothService.notify(
                ...
                new BleCharacterCallback() {
                    ...
                    public void onSuccess(final BluetoothGattCharacteristic characteristic) {
                        ...
                        int auth = commondUtils.resolveAuth(BR16PUMasterActivity.this,characteristic.getValue());
                        if(-1 != auth){
...
//            progressDialog.show();
        ...
        public void onConnectFail() {
            Toast.makeText(BR16PUMasterActivity.this, "ConnectFail", Toast.LENGTH_LONG).show();
        }
        ...
        public void onDisConnected2Reconnect(){
            bluetoothFragment.changeConnectState(false);
            Toast.makeText(BR16PUMasterActivity.this, "Reconnecting", Toast.LENGTH_LONG).show();
        }
        @Override
        public void onServicesDiscovered() {
            ...
            Toast.makeText(BR16PUMasterActivity.this, "ServicesDiscovered", Toast.LENGTH_LONG).show();
        }
    };
