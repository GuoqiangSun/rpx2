...
public class Rp8OEMRXPMasterActivity extends BaseActivity {
    ...
    private Rp8OEMRXPMenuFragment menuFragment;
    ...
    private void initView() {
        ...
        menuFragment = new Rp8OEMRXPMenuFragment();
    ...
    public void setViewPagerCurrentItem(int currentItem) {
        viewPager.setCurrentItem(currentItem, false); // Rp8OEMRXPMenuFragment
    }
...
//            progressDialog.show();
        ...
        public void onConnectFail() {
            Toast.makeText(Rp8OEMRXPMasterActivity.this, "ConnectFail", Toast.LENGTH_LONG).show();
        }
        ...
        public void onDisConnected2Reconnect(){
            bluetoothFragment.changeConnectState(false);
            Toast.makeText(Rp8OEMRXPMasterActivity.this, "Reconnecting", Toast.LENGTH_LONG).show();
        }
        @Override
        public void onServicesDiscovered() {
            ...
            Toast.makeText(Rp8OEMRXPMasterActivity.this, "ServicesDiscovered", Toast.LENGTH_LONG).show();
        }
    };
