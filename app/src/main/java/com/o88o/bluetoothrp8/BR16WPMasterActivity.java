...
public class BR16WPMasterActivity extends BaseActivity {
    ...
    private BR16WPMenuFragment menuFragment;
    ...
    private void initView() {
        ...
        menuFragment = new BR16WPMenuFragment();
        ...
        mBluetoothService.notify(
                ...
                new BleCharacterCallback() {
                    ...
                    public void onSuccess(final BluetoothGattCharacteristic characteristic) {
                        ...
                        if(half){
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(BR16WPMasterActivity.this, "receive commend : " + hexStringFinal, Toast.LENGTH_LONG).show();
                                }
                            });
                        }
                        ...
                        int auth = commondUtils.resolveAuth(BR16WPMasterActivity.this,characteristic.getValue());
                        if(-1 != auth){
                    ...
                    public void onFailure(final BleException exception) {
                        /*BR16WPMasterActivity.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
    ...
    public void setViewPagerCurrentItem(int currentItem) {
        viewPager.setCurrentItem(currentItem, false); // BR16WPMenuFragment
    }
...
//            progressDialog.show();
        ...
        public void onConnectFail() {
            Toast.makeText(BR16WPMasterActivity.this, "ConnectFail", Toast.LENGTH_LONG).show();
        }
        ...
        public void onDisConnected2Reconnect(){
            bluetoothFragment.changeConnectState(false);
            Toast.makeText(BR16WPMasterActivity.this, "Reconnecting", Toast.LENGTH_LONG).show();
        }
        @Override
        public void onServicesDiscovered() {
            ...
            Toast.makeText(BR16WPMasterActivity.this, "ServicesDiscovered", Toast.LENGTH_LONG).show();
        }
    };
