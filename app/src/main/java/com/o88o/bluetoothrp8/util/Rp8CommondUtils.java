...
public class Rp8CommondUtils extends BaseCommondUtils{
    @Override
    protected Map resolveNotify(byte[] notifyByte) {
        ...
        if (1 == btnStatus8[8 + 8 - Rp8Commond.LOW_BIT_9]) {
    ...
    /*private static boolean checkResponseCommond(String notify) {
        ...
        if(!notify.startsWith(Rp8Commond.HEX_COMMOND_RESPONSE_START)){
            return false;
        }
        return true;
    }*/
    ...
    protected boolean check(String notify) {
        ...
        if (!notify.toUpperCase().startsWith(Rp8Commond.HEX_COMMOND_START)) {
            return false;
        }
    ...
    protected boolean checkNotfiy(String notify) {
        ...
        if(!notify.toUpperCase().startsWith(Rp8Commond.HEX_COMMOND_NOTIFY_START)){
            return false;
        }
        return true;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(crc8("55AA03120000"));  // C6
    }
}
