...
public class Rp8GTMasterActivity extends BaseActivity  {
    ...
    private Rp8GTMenuFragment menuFragment;
    ...
    private void initView() {
        ...
        menuFragment = new Rp8GTMenuFragment();
    ...
    public void setViewPagerCurrentItem(int currentItem) {
        viewPager.setCurrentItem(currentItem, false); // Rp8MenuFragment
    }
...
//            progressDialog.show();
        ...
        public void onConnectFail() {
            Toast.makeText(Rp8GTMasterActivity.this, "ConnectFail", Toast.LENGTH_LONG).show();
        }
        ...
        public void onDisConnected2Reconnect(){
            bluetoothFragment.changeConnectState(false);
            Toast.makeText(Rp8GTMasterActivity.this, "Reconnecting", Toast.LENGTH_LONG).show();
        }
        @Override
        public void onServicesDiscovered() {
            ...
            Toast.makeText(Rp8GTMasterActivity.this, "ServicesDiscovered", Toast.LENGTH_LONG).show();
        }
    };
