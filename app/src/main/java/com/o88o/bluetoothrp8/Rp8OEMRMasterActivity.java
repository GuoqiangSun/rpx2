...
public class Rp8OEMRMasterActivity extends BaseActivity {
    ...
    private Rp8OEMRMenuFragment menuFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rp8_layout_main);
        initView();
    ...
    private void initView() {
        ...
        menuFragment = new Rp8OEMRMenuFragment();
    ...
    public void setViewPagerCurrentItem(int currentItem) {
        viewPager.setCurrentItem(currentItem, false); // Rp8OEMRMenuFragment
    }

    public void newFbPopup(View rootView) {

        mResultAdapter = new com.o88o.bluetoothrp8.widget.ResultAdapter(this);
        fbPopup = new com.o88o.bluetoothrp8.widget.FbPopup(this,rootView,mBluetoothService,mResultAdapter,operatingAnim);
    }
...
//            progressDialog.show();
        ...
        public void onConnectFail() {
            Toast.makeText(Rp8OEMRMasterActivity.this, "ConnectFail", Toast.LENGTH_LONG).show();
        }
        ...
        public void onDisConnected2Reconnect(){
            bluetoothFragment.changeConnectState(false);
            Toast.makeText(Rp8OEMRMasterActivity.this, "Reconnecting", Toast.LENGTH_LONG).show();
        }
        @Override
        public void onServicesDiscovered() {
            ...
            Toast.makeText(Rp8OEMRMasterActivity.this, "ServicesDiscovered", Toast.LENGTH_LONG).show();
        }
    };
